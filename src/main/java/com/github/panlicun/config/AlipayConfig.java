...
import com.github.panlicun.enums.SignTypeEnum;
...
public class AlipayConfig extends PayConfig {
    ...
    public void setAppRSAPrivateKeyObject(PrivateKey appRSAPrivateKeyObject) {
    ...
    public void setAlipayRSAPublicKeyOBject(PublicKey alipayRSAPublicKeyOBject) {
